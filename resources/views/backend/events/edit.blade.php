                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('seats') is-invalid @enderror"
                                            id="seats" name="seats" value="{{ old('seats', $event->seats) }}">
                                        @error('seats')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('admission') is-invalid @enderror"
                                            ...
                                            value="{{ old('admission', $event->admission) }}">
                                        @error('admission')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        @if ($event->image)
                                            <div class="mt-2">
                                                <img src="{{ asset('storage/' . $event->image) }}" height="80"
                                                    alt="{{ $event->title }}">
                                            </div>
                                        @endif
                                    </div>
                                    ...
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <textarea class="form-control @error('intro') is-invalid @enderror" id="intro" name="intro" rows="3">{{ old('intro', $event->intro) }}</textarea>
                                        @error('intro')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <div id="pointsWrapper">
                                            @php $points = old('points', $event->points ?? []); @endphp
                                    ...
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <textarea class="form-control @error('audience') is-invalid @enderror" id="audience" name="audience"
                                            rows="2">{{ old('audience', $event->audience) }}</textarea>
                                        @error('audience')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="text"
                                            ...
                                            id="speaker_role" name="speaker_role"
                                            value="{{ old('speaker_role', $event->speaker_role) }}">
                                        @error('speaker_role')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
