                            ...
                            <form action="{{ route('admin.services.store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select name="type" id="type"
                                            ...
                                            <option value="traditional"
                                                {{ old('type') == 'traditional' ? 'selected' : '' }}>Traditional</option>
                                    ...
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <textarea class="form-control @error('body') is-invalid @enderror" id="body" name="body" rows="8">{{ old('body') }}</textarea>
                                        @error('body')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="file"
                                            class="form-control @error('catalog_pdf') is-invalid @enderror" id="catalog_pdf"
                                            name="catalog_pdf" accept=".pdf">
                                        @error('catalog_pdf')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
