                            ...
                            <form action="{{ route('admin.registrations.update', $registration->id) }}" method="POST">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('name') is-invalid @enderror"
                                            id="name" name="name" value="{{ old('name', $registration->name) }}"
                                            required>
                                        @error('name')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="email" class="form-control @error('email') is-invalid @enderror"
                                            id="email" name="email" value="{{ old('email', $registration->email) }}"
                                            required>
                                        @error('email')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('phone') is-invalid @enderror"
                                            id="phone" name="phone" value="{{ old('phone', $registration->phone) }}"
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select name="participant_type" id="participant_type"
                                            ...
                                            <option value="undergraduate"
                                                {{ old('participant_type', $registration->participant_type) == 'undergraduate' ? 'selected' : '' }}>
                                                Undergraduate Student</option>
                                            <option value="postgraduate"
                                                {{ old('participant_type', $registration->participant_type) == 'postgraduate' ? 'selected' : '' }}>
                                                Postgraduate Student</option>
                                            <option value="faculty"
                                                {{ old('participant_type', $registration->participant_type) == 'faculty' ? 'selected' : '' }}>
                                                Faculty Member</option>
                                            <option value="alumni"
                                                {{ old('participant_type', $registration->participant_type) == 'alumni' ? 'selected' : '' }}>
                                                Alumni</option>
                                            <option value="external"
                                                {{ old('participant_type', $registration->participant_type) == 'external' ? 'selected' : '' }}>
                                    ...
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <textarea class="form-control @error('message') is-invalid @enderror" id="message" name="message" rows="3">{{ old('message', $registration->message) }}</textarea>
                                        @error('message')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="mt-3">
                                    <p><strong>Registration Code:</strong>
                                        <code>{{ $registration->registration_code }}</code></p>
                                    <p><strong>Registered At:</strong>
                                        {{ $registration->created_at->format('d F Y, h:i A') }}</p>
                                    @if ($registration->confirmed_at)
                                        <p><strong>Confirmed At:</strong>
                                            {{ $registration->confirmed_at->format('d F Y, h:i A') }}</p>
                                    @endif
                                </div>
