...
<main class="main">
  <section class="page-banner"
    style="background: linear-gradient(rgba(0,0,0,0.65), rgba(0,0,0,0.65)), url('{{ asset('assets/img/services.jpg') }}') center/cover no-repeat; min-height: 320px;">
    
    <div class="container h-100 d-flex flex-column align-items-center justify-content-center text-white text-center py-5">
        
        {{-- Breadcrumb --}}
        <nav class="mb-2">
            <small class="text-uppercase letter-spacing-1 opacity-75">Services</small>
        </nav>
        ...
        {{-- Breadcrumb Links --}}
        <div class="d-flex align-items-center gap-2 mb-4 opacity-75 small">
        ...
        {{-- Divider --}}
        <div class="border-bottom border-secondary w-25 mb-4"></div>

        {{-- Reviews --}}
        <div>
            <h5 class="fw-semibold mb-1" style="color: white !important;">Client Reviews</h5>
            <div class="d-flex align-items-center justify-content-center gap-2">
                ...
                <span class="opacity-75 small">
                    {{ number_format($service->average_rating, 1) }}/5
                    &bull; {{ $service->reviews_count }} reviews
                </span>
            </div>
        </div>
